          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                  ...
                  children: [
                    ToggleButtonLoginRegister(onPressed: () {
                        setState(() {
                          _isLoginMode = true;
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      _isLoginMode ? 'Login' : 'Buat Akun Pandai',
                      style: TextStyle(
                        fontSize: 26.0,
                    ...
                    Text(
                      _isLoginMode ? 'Masuk ke akun anda' : 'Buat akun mudah, hanya dengan mengisi form berikut',
                      style: TextStyle(
                        fontSize: 16.0,
